...
int main()
{
	...
	ofstream fout1("СipherText.txt");

	for (int i = 0; i < LenOfPaddedMessage; i++)
	{
		printf("%02x ", PaddedMessage[i]);
		cout << " ";
		fout1 << hex << PaddedMessage[i];
	}
	...
	ofstream fout2("DecipheredText.txt");

	for (int i = 0; i < LenOfPaddedMessage; i++)
	{
		printf("%02x ", PaddedMessage[i]);
		cout << " ";
		fout2 << hex << PaddedMessage[i];
	}
